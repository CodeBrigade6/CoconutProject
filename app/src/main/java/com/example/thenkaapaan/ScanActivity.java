...
import com.example.thenkaapaan.ml.Cocodisease;
...
public class ScanActivity extends AppCompatActivity {
    ...
    private void classifyImage(Bitmap image) {
        try {
            Cocodisease model= Cocodisease.newInstance(getApplicationContext());
            ...
            Cocodisease.Outputs outputs= model.process(inputFeature0);
            ...
            String[] classes = {"Healthy Coconut","Caterpillar Disease","Eriophyid Mite","Rhino Beetle"};
            ...
            e.printStackTrace();
            Toast.makeText(this, "Failed to perform inference", Toast.LENGTH_SHORT).show();
